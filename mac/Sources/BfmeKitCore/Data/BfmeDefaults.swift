...
public enum BfmeDefaults {
    public static let defaultGameRegistryKeys: [Int: String] = [
    ...
    public static let deprecatedGameRegistryKeys: [Int: String] = [
    ...
    public static let defaultUserDataLeafNames: [Int: String] = [
        0: "My Battle for Middle-earth Files",
        1: "My Battle for Middle-earth II Files",
        2: "My Rise of the Witch-king Files"
    ]

    public static let defaultGameExecutableNames: [Int: String] = [
        0: "lotrbfme.exe",
        1: "lotrbfme2.exe",
        2: "lotrbfme2ep1.exe"
    ]
